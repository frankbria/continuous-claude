...
- docs(spec): add spec for better PR issues handling (5be9c60)
...
**Full Changelog**: https://github.com/frankbria/continuous-claude/compare/v0.0.0...v0.1.0
...
```bash
curl -fsSL https://raw.githubusercontent.com/frankbria/continuous-claude/refs/tags/v0.1.0/install.sh | bash
```

Or download the script directly:

```bash
curl -fsSL https://raw.githubusercontent.com/frankbria/continuous-claude/refs/tags/v0.1.0/continuous_claude.sh -o continuous-claude
